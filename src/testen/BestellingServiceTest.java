...
class BestellingServiceTest {
	...
	@BeforeEach
	void maakBestelling() {
		bestellingGeplaatst = new Bestelling(ORDER_ID, DATE, STATUS_GEPLAATST, LEVERANCIER, KLANT, TRANSPORTDIENST,
				AANKOPER, LEVERADRES_STRAAT, LEVERADRES_POSTCODE, LEVERADRES_STAD, LEVERADRES_LAND,
				LEVERADRES_HUISNUMMER, DOOS);
		bestellingVerwerkt = new Bestelling(ORDER_ID, DATE, STATUS_VERWERKT, LEVERANCIER, KLANT, TRANSPORTDIENST,
				AANKOPER, LEVERADRES_STRAAT, LEVERADRES_POSTCODE, LEVERADRES_STAD, LEVERADRES_LAND,
				LEVERADRES_HUISNUMMER, DOOS);
...
//	}
	...
	void testGetBestellingen() {
		Bestelling bestelling = new Bestelling(ORDER_ID, DATE, STATUS_GEPLAATST, LEVERANCIER, KLANT, TRANSPORTDIENST,
				AANKOPER, LEVERADRES_STRAAT, LEVERADRES_HUISNUMMER, LEVERADRES_POSTCODE, LEVERADRES_STAD,
				LEVERADRES_LAND, DOOS);
		Bestelling bestelling2 = new Bestelling(ORDER_ID, DATE, STATUS_GEPLAATST, LEVERANCIER, KLANT, TRANSPORTDIENST,
				AANKOPER, LEVERADRES_STRAAT, LEVERADRES_HUISNUMMER, LEVERADRES_POSTCODE, LEVERADRES_STAD,
				LEVERADRES_LAND, DOOS);
